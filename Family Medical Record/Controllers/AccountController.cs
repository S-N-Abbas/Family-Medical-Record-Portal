...
namespace Family_Medical_Record.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Register(RegisterViewModel model, HttpPostedFileBase imageUpload)
        {
            if (imageUpload != null)
            {
                ...
                pic = model.Username + "." + pic.Split('.')[1];
                ...
                model.Picture = "/images/" + pic;

            }
            else
            {
                model.Picture = "/Icons/User.png";
            }

            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { Picture = model.Picture, UserName = model.Username, Email = model.Email };
